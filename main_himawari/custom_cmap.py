# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 18:03:09 2015
...
def make_cmap(colors, position=None, bit=False):
    ...
    if position == None:
        ...
        if len(position) != len(colors):
            os.sys.exit("position length must be the same as colors")
        elif position[0] != 0 or position[-1] != 1:
            os.sys.exit("position must start with 0 and end with 1")
    if bit:
...
#colors = [(0,0,0),(0,0,0),(20,20,20),(216,216,216),(0,100,100),(0,248,248),\
#          (120,0,0),(252,252,0),(0,0,84),(0,0,252),(80,80,252),(140,140,252),\
#          (0,252,0),(252,252,252),(252,252,252),(252,252,252),(255,255,255),(255,255,255)]
#import numpy
#position = numpy.array([0,43,44,151,152,183,\
#                    184,203,204,215,216,223,\
#                    224,236,237,252,253,255])/255.0
#         
...
#### Use your colormap
#arr =np.random.rand(25,50)
#plt.pcolor(arr, cmap=my_cmap)
#plt.colorbar()
